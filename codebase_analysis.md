...
*   **Universal Markdown & Table Parser (`FormattedMarkdown.tsx`)**: Supports all heading levels H1 (`#`) through H6 (`######`), fixing Bengali/English H4 headings like `#### প্রাথমিক পদক্ষেপ:`. Includes support for fenced code blocks, inline code, markdown links (`[text](url)`), blockquotes, lists, badges, and responsive HTML tables.
